            ...
            <div className="flex justify-center">
                <div className="w-[452px] h-[296px] mt-[220px] p-[20px] text-center">
                    ...
                    <div className="flex justify-between items-baseline">
                        <button className="w-[48px] flex h-[48px] justify-center items-center text-black bg-slate-100 rounded-full text-2xl transition-transform transform active:scale-95 duration-300 hover:scale-110 hover:bg-black hover:text-white">
                            {/* <LeftArrow /> */}
                            </button>
