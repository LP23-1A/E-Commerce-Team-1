            ...
            <div className="flex justify-center">
                <div className="w-[452px] h-[296px] mt-[220px] p-[20px] text-center">
                    ...
                    <div className="w-[360xp] mt-[20px] h-[88px] flex flex-col gap-4">
                        <input style={inputStyle} value={inputValue} onChange={handleInputValue} className="border border-solid border-gray-300 bg-slate-100 p-2 rounded-lg" placeholder="name of store" type="text" />
                        <p className="text-red-400 semibold">{error}</p>
                    </div>
                    <div className="flex justify-between items-baseline">
                        <button className="w-[48px] flex h-[48px] justify-center items-center text-black bg-slate-100 rounded-full text-2xl transition-transform transform active:scale-95 duration-300 hover:scale-110 hover:bg-black hover:text-white">&#8592;</button>
