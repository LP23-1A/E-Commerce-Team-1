...
import { PineCone, RightArrow, LeftArrow } from "./Icon/index";
  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        ...
        <p className="absolute mt-[900px] ml-[-110px] text-slate-400">
          © 2023 Pinecone
        </p>
      </div>
    </>
