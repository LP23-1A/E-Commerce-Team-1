...
import { PineCone, LeftArrow, RightArrow } from "./Icon/index";
    ...
    <>
      ...
      <div className="flex justify-center">
        <div className="w-[452px] h-[296px] mt-[220px] p-[20px] text-center">
          ...
          <p className="font-semibold text-base text-black mt-2">
          ...
          <p className="absolute mt-[450px] ml-[150px] text-slate-400">
            © 2023 Pinecone
          </p>
        </div>
      </div>
