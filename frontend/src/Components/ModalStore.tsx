export default function ModalStoreSettings({ onchange, setModalStore, buttonActive, SaveInputStore }: any) {
    return (
        <div className="w-full flex bg-green-400 absolute h-full justify-center items-center" style={{ backgroundColor: 'rgba(0, 0, 0, .5)' }}>
            <div className="w-[551px] h-[341px] rounded-lg bg-white p-[24px]">
                <p className="text-xl font-bold">what kinds of product do you want to sell ?</p>
